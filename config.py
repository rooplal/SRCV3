...
LOG_GROUP    = int(os.getenv("LOG_GROUP", "-1005102994786"))
FORCE_SUB    = int(os.getenv("FORCE_SUB", "-1003888114653"))
...
# ─── UI / LINKS ─────────────────────────────────────────────────────────────────
JOIN_LINK     = os.getenv("JOIN_LINK", "https://t.me/+PYh-qoxO8nsyNDE9")
ADMIN_CONTACT = os.getenv("ADMIN_CONTACT", "https://t.me/Tg_Mr_X")
